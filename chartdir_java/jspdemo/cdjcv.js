//Copyright 2016 Advanced Software Engineering Ltd
...
_jcvxycp.lq4=function(c,la6){if(!c||(c=='?'))return la6;else return(c=='~')?"":c;}
...
_jcvxycp.formatValue=function(lu2,l56){if((!l56)||(l56.indexOf('{')==-1))return this.l74(l56,lu2);else return l56.replace(new RegExp("[{]value(?:|([^}]*))?[}]",'g'),this.l74("$1",lu2));}
...
function _jcva(ls6,ll5){this.lx4=ls6;this.data=ll5;}
...
_jcvap.lp3=function(lu6){if(lu6==null)return null;var lq2=(lu6-this.data.minC)/(this.data.maxC-this.data.minC);if(this.data.st!=4)return lq2*(this.data.maxV-this.data.minV)+this.data.minV;else return Math.pow(this.data.maxV/this.data.minV,lq2)*this.data.minV;}
...
function _jcvl(ls6,ls5){this.lx4=ls6;this.lu3=ls5;}
...
return ll5.obj;}
_jcvlp.getDataSetById=function(id){var ly6=this.lu3.dataSets;for(var i=0;i<ly6.length;++i){if(ly6[i].id==id)return this.getDataSet(i);}
return null;}
_jcvlp.getDataSetByZ=function(i){return this.getDataSet(this.lu3.dataSets.length-i-1);}
_jcvlp.getDataSetCount=function(){var ly6=this.lu3.dataSets;return ly6?ly6.length:0;}
...
return i;}
_jcvlp.getXCoor=function(){if(!this.lu3.lw4){var lz6=0;for(var j=0;j<this.lu3.dataSets.length;++j)lz6=Math.max(lz6,this.lu3.dataSets[j].data.length);var lw5=this.lx4.xAxis();var ls2=Math.min(lw5.getMinValue(),lw5.getMaxValue());var lt2=Math.max(lw5.getMinValue(),lw5.getMaxValue());var l07=[];for(var i=0;i<lz6;++i){var l17=this.getXPosition(i);if((l17==null)||(l17>lt2)||(l17<ls2))l07[i]=null;else l07[i]=lw5.ln3(l17);}
this.lu3.lw4=l07;}
return this.lu3.lw4;}
_jcvlp.getNearestXIndex=function(ly){var l07=this.getXCoor();if((ly==null)||!l07||!l07.length)return null;var l27=this.lu3.lv4;if(l07!=this.lu3.l44){l27=[];for(var i=0;i<l07.length;++i)l27[i]=i;l27.sort(function(a,b){return _jcv.lz3(l07[a],l07[b]);});this.lu3.lv4=l27;this.lu3.l44=l07;}
var l51=ase_61(l27,ly,function(a,b){return _jcv.lz3(l07[a],b);});if(l51>=0)return l27[l51];l51=~l51;if(l51>=l27.length)return l27[l27.length-1];if(l51==0)return l27[0];var l37=l27[l51-1];var l47=l27[l51];if((l07[l37]==null)||(ly-l07[l37]>l07[l47]-ly))return l47;else return l37;}
_jcvlp.getNearestXValue=function(ly){var l51=this.getNearestXIndex(ly);return(l51!=null)?this.getXPosition(l51):null;}
_jcvlp.getXIndexOf=function(l17,l57){if(!l57)l57=0;var l51=this.getNearestXIndex(this.lx4.xAxis().ln3(l17));return((l51==null)||(Math.abs(this.getXPosition(l51)-l17)>l57))?null:l51;}
function _jcvd(ls6,ll5){this.lx4=ls6;this.data=ll5;}
...
_jcvdp.getPosition=function(i){var lu2=this.getValue(i);if(lu2==null)return null;var l77=this.getDataSetNo();var l87=this.getDataGroup();switch(this.lx4.lu3.dcm){case 1:for(var j=l77-1;(j>=0)&&(this.lx4.getDataSet(j).getDataGroup()==l87);--j){var v=this.lx4.getDataSet(j).getValue(i);if((v!=null)&&((lu2>=0)^(v<0)))lu2+=v;}
return lu2;case 4:lu2=Math.abs(lu2);var l97=1;for(var k=l77-1;(k>=0)&&(this.lx4.getDataSet(k).getDataGroup()==l87);--k){var v=this.lx4.getDataSet(k).getValue(i);if(v!=null){++l97;lu2+=Math.abs(v);}
}
var la7=lu2;var lb7=l97;for(var n=l77+1;(n<this.lx4.getDataSetCount())&&(this.lx4.getDataSet(n).getDataGroup()==l87);++n){var v=this.lx4.getDataSet(n).getValue(i);if(v!=null){++lb7;la7+=Math.abs(v);}
}
...
_jcv.lc3=[0,31,59,90,120,151,181,212,243,273,304,334];_jcv.l54=function(le7,lf7){var l51=_jcv.lc3[lf7-1];if((lf7>2)&&_jcv.ls3(le7))++l51;return l51;}
...
_jcvp.l41=function(e){var eX=ase_q(e);var eY=ase_r(e);if(this.la==_jcv.ZoomIn){var d=this.lc;var li7=this.ls1()&&this.ll1(e,d);if(li7){var ls2=Math.min(eX,this.l93);var lj7=Math.min(eY,this.la3);var l84=Math.abs(eX-this.l93);var l94=Math.abs(eY-this.la3);switch(d){case _jcv.Horizontal:this.l12(ls2,this.l43(this.l1),l84,this.l13(this.l3));break;case _jcv.Vertical:this.l12(this.l33(this.l0),lj7,this.l23(this.l2),l94);break;default:this.l12(ls2,lj7,l84,l94);break;}
}
this.l22(li7);}
...
_jcvp.lx1=function(e,ll7){var eX=ase_q(e);var eY=ase_r(e);var lm7=this.l6/ll7;var ln7=this.l7/ll7;this.lo1(this.lc,(this.l73(eX)-this.l0)*this.l6/this.l2-lm7/2,lm7,(this.l83(eY)-this.l1)*this.l7/this.l3-ln7/2,ln7);}
...
_jcvp.lv1=function(e){var eX=ase_q(e);var eY=ase_r(e);var lm7=this.l6*this.l63(Math.abs(this.l93-eX))/this.l2;var ln7=this.l7*this.l53(Math.abs(this.la3-eY))/this.l3;this.lo1(this.lc,this.l6*(this.l73(Math.min(this.l93,eX))-this.l0)/this.l2,lm7,this.l7*(this.l83(Math.min(this.la3,eY))-this.l1)/this.l3,ln7);}
_jcvp.lo1=function(d,lm1,lo7,ln1,lp7){var lq7=this.l4;var lr7=this.l5;var lm7=this.l6;var ln7=this.l7;if((((lo7<this.l6)&&(this.l6<this.lf))||(d==_jcv.Vertical))&&(((lp7<this.l7)&&(this.l7<this.lh))||(d==_jcv.Horizontal)))return;if(d!=_jcv.Vertical){if(lo7!=this.l6){lm7=Math.max(this.lf,Math.min(lo7,this.lg));lm1-=(lm7-lo7)/2;}
...
if((lq7!=this.l4)||(lr7!=this.l5)||(lm7!=this.l6)||(ln7!=this.l7)){this.ly2=this.l4;this.lz2=this.l5;this.l03=this.l6;this.lx2=this.l7;this.l4=lq7;this.l5=lr7;this.l6=lm7;this.l7=ln7;this.raiseViewPortChangedEvent();}
}
_jcvp.zoomAt=function(x,y,ll7){var ls7=(x-this.l0)/this.l2;var lt7=(y-this.l1)/this.l3;var rx=(this.lc!=_jcv.Vertical)?1/ll7:1;var ry=(this.lc!=_jcv.Horizontal)?1/ll7:1;var lm7=Math.max(this.lf,this.l6*rx);var lm1=ls7*(this.l6-lm7);var ln7=Math.max(this.lh,this.l7*ry);var ln1=lt7*(this.l7-ln7);this.lo1(this.lc,lm1,lm7,ln1,ln7);}
...
else {if(lw7=="chartmove")this.l65();if((lw7.length>7)&&(lw7.substr(lw7.length-7,7)=="hotspot"))this.initToolTipHandler();var a=this.l52(lf5);a.push(f);return lf5+":"+(a.length-1);}
}
...
_jcvp.l45=function(lp,lf5,ly7){this.lw3(lf5);this.l57=lf5;var l51=false;var a=this.l52(lf5);for(var i=0;i<a.length;++i){this.lb3=a[i];if(a[i])l51|=a[i].call(lp,ly7);}
this.l57=null;return l51;}
_jcvp.l55=function(lp,lf5,e){var lz7=e.changedTouches[0];this.l07(ase_q(lz7),ase_r(lz7));this.lk6=e.type;this.l45(lp,lf5,e);this.lk6=null;}
...
_jcvp.applyHandlers=function(lf5,ly7){return this.l45(this,lf5,ly7);}
...
_jcvp.partialUpdate=function(l08,l18){if(this.l32)return;_jcv.lu1(this.la2());this.applyHandlers("preupdate");this.lv2();var lw="cdPartialUpdate="+this.l21+"&cdCacheDefeat="+ase_h();if(l18)lw+="&cdAttachment=1";if(l08)lw+="&"+l08;lw+="&"+this.lb2.name+"="+ase_21(escape(this.lb2.value),'\\+','%2B');var lv=ase_11(ase_a(this.l21+"_callBackURL").value,lw);if(l18){switch(l18){case "_self":location=lv;break;case "hidden":var id=this.l21+"_loader_frame";var l28=ase_a(id);if(!l28){l28=document.createElement("IFRAME");l28.id=id;var s=l28.style;s.position="absolute";s.left="0px";s.top="0px";s.display="none";s.visibility="hidden";document.body.appendChild(l28);}
l28.src=lv;break;default:window.open(lv,l18);}
return;}
var l38=this.updatingMsg;if(ase_g(l38))l38=_jcv.updatingMsg;if(l38&&(l38!="none"))this.msgBox(l38);this.ln=1;var lp5=this;this.l32=ase_j1(lv,function(t){lp5.ll2(t)},function(l48,l58){lp5.le1(l48,l58);});}
_jcvp.ll2=function(lr1){var l68=ase_e1(lr1,"<!--CD_SCRIPT "," CD_SCRIPT-->");if(l68){var l78=ase_e1(lr1,"<!--CD_MAP "," CD_MAP-->");var imgObj=this.la2();var imgBuffer=(this.ln1=(this.doubleBuffering?new Image():null))||imgObj;if(imgObj.useMap)imgObj.useMap=null;imgObj.loadImageMap=function(){window.setTimeout(function(){_jcv.putMap(imgObj,l78);},100);};imgBuffer.onload=function(){imgObj._jcv.onPartialLoad(true);}
imgBuffer.onerror=imgBuffer.onabort=function(l03){imgObj._jcv.le1(999,"Error loading image '"+this.src+"'["+l03+"]");}
var l98=window.onerror;window.onerror=function(l03){imgObj._jcv.le1(801,"Error interpretating partial update result ["+l03+"] <div style='margin:20px;background:#dddddd'><xmp>"+l68+"</xmp></div>")};eval(l68);window.onerror=l98;if(ase_2)this.lv2();}
else this.le1(800,"Partial update returns invalid data <div style='margin:20px;background:#dddddd'><xmp>"+lr1+"</xmp></div>");}
_jcvp.ld1=function(la8){var imgObj=this.la2();var imgBuffer=this.ln1||imgObj;if(imgBuffer)imgBuffer.onerror=imgBuffer.onabort=imgBuffer.onload='';imgObj.onUpdateCompleted='';this.l32=false;this.li1(this.lg1());if(la8){this.ly2=this.l4;this.lx2=this.l7;this.lz2=this.l5;this.l03=this.l6;if(imgObj!=imgBuffer){imgObj.src=imgBuffer.src;imgObj.style.width=imgBuffer.style.width;imgObj.style.height=imgBuffer.style.height;}
imgObj.loadImageMap();}
...
imgObj.loadImageMap='';}
_jcvp.onPartialLoad=function(la8){if(this.la2().onUpdateCompleted)this.la2().onUpdateCompleted();else this.msgBox();this.ld1(la8);window[this.getId()+"_chartModel"]=window[this.getId()+"_pending_chartModel"];this.l15();this.applyHandlers("postupdate");}
_jcvp.le1=function(l48,l58){this.ld1(false);this.msgBox();this.errCode=l48;this.errMsg=l58;if(!this.applyHandlers("updateerror")){var lb8=this.serverErrorMsg;if(!lb8)lb8=_jcv.serverErrorMsg;if(lb8&&(lb8!="none"))this.msgBox(ase_21(ase_21(lb8,'%errCode',l48),'%errMsg',l58));}
...
_jcvp.streamUpdate=function(lc8,l08){var lp1=ase_h();if(!lc8)lc8=60;var ll6=this.lm2;if(ll6){if(lc8*1000>=lp1-ll6.lm1)return false;ll6.src=null;ll6.onerror=ll6.onabort=ll6.onload=null;}
if(!this.lk2)this.lk2=this.la2().src;this.lm2=ll6=this.la2();ll6.lm1=lp1;var lp5=this;ll6.onload=function(){var imgObj=lp5.la2();if(imgObj.useMap)imgObj.useMap=null;var b=lp5.lm2;if(imgObj!=b)imgObj.src=b.src;b.onabort();}
ll6.onerror=ll6.onabort=function(){var b=lp5.lm2;if(b)b.onload=b.onabort=b.onerror=null;lp5.lm2=null;}
var lw="cdDirectStream="+this.l21+"&cdCacheDefeat="+lp1;if(l08)lw+="&"+l08;ll6.src=ase_11(this.lk2,lw);return true;}
...
return l51;}
_jcvp.decodeState=function(s){var ld8=s.split("\x1e");for(var i=0;i<ld8.length;++i){var av=this.lp1(ld8[i]);if(!av)continue;var a=_jcv.l02[parseInt(av.attr)];if(a=="lo"){var le8=av.value.split("\x1f");for(var i2=0;i2<le8.length;++i2){var lg8=this.lp1(le8[i2]);if(!lg8)continue;this.lo[lg8.attr]=lg8.value;}
}
...
_jcv.l42=function(imgObj){var lh8=imgObj.lt2;if(!lh8)lh8=imgObj.useMap;if(!lh8)return null;var l41=lh8.indexOf('#');if(l41>=0)lh8=lh8.substring(l41+1);var l51=ase_a(lh8);if(!l51){l51=document.getElementsByName(lh8);l51=l51?l51[0]:null;}
return l51;}
_jcv.loadMap=function(imgObj,lv){if(!imgObj.lt2)imgObj.lt2=imgObj.useMap;_jcv.lu1(imgObj);imgObj.lc2=ase_j1(lv,function(t){_jcv.putMap(imgObj,ase_e1(t,"<!--CD_MAP "," CD_MAP-->"));},function(l48,l58){_jcv.onLoadMapError(l48,l58);}
);}
...
_jcv.putMap=function(imgObj,li8){var m=_jcv.l42(imgObj);if(!m&&li8){var lh8='map_'+imgObj.id;imgObj.useMap=imgObj.lt2='#'+lh8;var d=document;m=d.createElement("MAP");m.id=m.name=lh8;d.body.appendChild(m);if(imgObj._jcv)imgObj._jcv.l92();}
if(m){m.innerHTML=li8;m.ll6=m.lm6=1;if(imgObj.useMap!=imgObj.lt2)imgObj.useMap=imgObj.lt2;var lp5=_jcv.get(imgObj.id);if(lp5&&lp5.l85)lp5.lq7();}
imgObj.lc2=null;}
_jcv.canSupportPartialUpdate=function(){return(window.XMLHttpRequest||ase_i1());}
_jcv.getVersion=function(){return ase_0;}
function _jvpc(id){this.lf8=id;this.le8=null;this.ld8=null;this.li5=4;this.lj5=8;this.lb5=_jcv.lm5;var lp=this.lz7("root");var lj8=["maskTop","maskBottom","maskLeft","maskRight","pad","sel"];var i=0;for(i=0;i<lj8.length;++i){if(this.lz7(lj8[i]))continue;var lk8=document.createElement("DIV");lk8.id=this.lg8(lj8[i]);var s=lk8.style;s.position="absolute";if(i>3)s.visibility="hidden";lk8.innerHTML="<img style='display:none' />";lp.appendChild(lk8);}
...
_jvpcp=_jvpc.prototype;_jvpcp.lr8=function(){var cv=_jcv.get(this.lf8);cv.lh5();var lo8=["l01","l11","l0","l1","l2","l3"];for(i=0;i<lo8.length;++i)this[lo8[i]]=cv[lo8[i]];if(++this.l2>0)++this.l3;else {this.l0=this.l1=0;this.l2=this.l01;this.l3=this.l11;}
...
_jvpcp.setMouseMargin=function(lq8,lr8){this.li5=lq8;this.lj5=lr8;}
_jvpcp.setViewPortExternalColor=function(lj5){this.lp8=lj5;}
_jvpcp.getViewPortExternalColor=function(){return this.lp8;}
_jvpcp.setViewPortBorderStyle=function(ls8){this.lo8=ls8;}
_jvpcp.getViewPortBorderStyle=function(){return this.lo8;}
_jvpcp.setSelectionBorderStyle=function(ls8){this.lq8=ls8;}
...
_jvpcp.l75=function(){var lu8=_jvpc.l67(this.lf8,_jvpcp.l68);window.setInterval(lu8,_jcv.moveConfirmTimer);ase_z(window,"resize",lu8,false);ase_z(this.lz7("root"),"resize",lu8,false);}
...
_jvpcp.lx5=function(x,y,lv4,lx4,lw4,ly4){var lv8=x+x-lv4-lw4;var lw8=y+y-lx4-ly4;return lv8*lv8+lw8*lw8;}
...
_jvpcp.lo6=function(lx8,ly8,x,y,x2,y2,lq8,lr8){if(lq8>lr8)return this.ln6(lx8,ly8,x-lq8,y-lq8,x+lq8,y+lq8);var l09=lr8*ase_f(x2-x);var lz8=lr8*ase_f(y2-y);if(this.lq6(lx8,ly8,x,y,lz8,lq8)||(this.lq6(ly8,lx8,y,x,l09,lq8)))return this.lx5(lx8,ly8,x,y,x,y);else return-1;}
_jvpcp.lp6=function(l15,x,y,lv4,lx4,lw4,ly4){var l19=this.li5;var l29=this.lj5;switch(l15){case _jcv.Left:return this.ln6(x,y,lv4-l19,lx4,lv4+l19,ly4);case _jcv.Right:return this.ln6(x,y,lw4-l19,lx4,lw4+l19,ly4);case _jcv.Top:return this.ln6(x,y,lv4,lx4-l19,lw4,lx4+l19);case _jcv.Bottom:return this.ln6(x,y,lv4,ly4-l19,lw4,ly4+l19);case _jcv.TopLeft:return this.lo6(x,y,lv4,lx4,lw4,ly4,l19,l29);case _jcv.TopRight:return this.lo6(x,y,lw4,lx4,lv4,ly4,l19,l29);case _jcv.BottomLeft:return this.lo6(x,y,lv4,ly4,lw4,lx4,l19,l29);case _jcv.BottomRight:return this.lo6(x,y,lw4,ly4,lv4,lx4,l19,l29);case _jcv.ll5:return this.ln6(x,y,lv4,lx4,lw4,ly4);default:return-1;}
}
_jvpcp.ly5=function(lx8,ly8){var l39=[];var l49=0;if(this.lm8)l39[l49++]=_jcv.ll5;if(this.ll8){switch(this.getViewer().lc){case _jcv.Horizontal:l39[l49++]=_jcv.Left;l39[l49++]=_jcv.Right;break;case _jcv.Vertical:l39[l49++]=_jcv.Top;l39[l49++]=_jcv.Bottom;break;case _jcv.HorizontalVertical:l39[l49++]=_jcv.Left;l39[l49++]=_jcv.Right;l39[l49++]=_jcv.Top;l39[l49++]=_jcv.Bottom;l39[l49++]=_jcv.TopLeft;l39[l49++]=_jcv.TopRight;l39[l49++]=_jcv.BottomLeft;l39[l49++]=_jcv.BottomRight;break;}
}
var l59=this.lz7("pad");var lv4=l59.lr5+Math.round((l59.lo5-l59.offsetWidth)/2);var lx4=l59.ls5+Math.round((l59.ln5-l59.offsetHeight)/2);var lw4=lv4+l59.offsetWidth;var ly4=lx4+l59.offsetHeight;var l69=-1;var l79=0x7fffffff;for(var i=0;i<l49;++i){var l89=this.lp6(l39[i],lx8,ly8,lv4,lx4,lw4,ly4);if((l89>=0)&&(l89<l79)){l79=l89;l69=i;}
}
return(l69>=0)?l39[l69]:_jcv.lk5;}
...
_jvpcp.le7=function(l99,la9,l43,l53){var l59=this.lz7("pad");l59.lr5=this.l17(l99);l59.ls5=this.l27(la9);l59.lo5=this.l17(l99+l43)-l59.lr5;l59.ln5=this.l27(la9+l53)-l59.ls5;this.l38();}
_jvpcp.ls7=function(){var l59=this.lz7("pad");var lb9=(l59.lr5==l59.l66)&&(l59.lo5==l59.l56);var lc9=(l59.ls5==l59.l76)&&(l59.ln5==l59.l46);if(!(lb9&&lc9))this.lc8(l59.lr5,l59.ls5,l59.lo5,l59.ln5,lb9,lc9);}
_jvpcp.l38=function(){var lp5=this.getViewer();var l59=this.lz7("pad");var ld9=this.lz7("sel");var le9=this.l17(0);var lf9=this.l17(1);var lg9=this.l27(0);var lh9=this.l27(1);if(this.ld7()){var li9=lp5.lc!=_jcv.Vertical;var lj9=lp5.lc!=_jcv.Horizontal;var lv4=Math.min(this.lc5,this.l95);var lw4=Math.max(this.lc5,this.l95);var lx4=Math.min(this.ld5,this.la5);var ly4=Math.max(this.ld5,this.la5);if((li9&&((lv4>lf9)||(lw4<le9)))||(lj9&&((lx4>lh9)||(ly4<lg9)))){ld9.style.visibility="hidden";return;}
lv4=li9?ase_d(le9,lv4,lf9):l59.l66;lw4=li9?ase_d(le9,lw4,lf9):(l59.l66+l59.l56);lx4=lj9?ase_d(lg9,lx4,lh9):l59.l76;ly4=lj9?ase_d(lg9,ly4,lh9):(l59.l76+l59.l46);ld9.lr5=lv4;ld9.ls5=lx4;ld9.lo5=lw4-lv4;ld9.ln5=ly4-lx4;ld9.style.border=this.lj8(this.lq8,"1px solid gray");this.l28(ld9,lv4,lx4,lw4,ly4);ld9.style.visibility="visible";}
else {ld9.style.visibility="hidden";this.lz7("pad").style.border=this.lj8(this.lo8,"1px solid gray");this.l28(l59,l59.lr5,l59.ls5,l59.lr5+l59.lo5,l59.ls5+l59.ln5);this.l18("maskLeft",le9,lg9,l59.lr5,lh9);this.l18("maskRight",l59.lr5+l59.lo5,lg9,lf9,lh9);this.l18("maskTop",l59.lr5,lg9,l59.lr5+l59.lo5,l59.ls5);this.l18("maskBottom",l59.lr5,l59.ls5+l59.ln5,l59.lr5+l59.lo5,lh9);}
}
...
_jvpcp.onMouseDown=function(e){var lp=this.lz7("root");var l59=this.lz7("pad");var lp5=this.getViewer();if((null==lp5)||lp5.l32||(ase_s(e)!=1))return;var mX=this.lx7(e);var mY=this.ly7(e);if(!this.lu6(mX,mY))return;this.l98=true;this.l86=null;this.l96=null;ase_b(e);if(window.onmousemove!=lp.onmousemove){if(lp.setCapture)lp.setCapture();lp.lo7=window.onmousemove;lp.lp7=window.onmouseup;window.onmousemove=lp.onmousemove;window.onmouseup=lp.onmouseup;}
this.lc5=this.l95=mX;this.ld5=this.la5=mY;this.lb5=this.ly5(mX,mY);l59.l66=l59.lr5;l59.l76=l59.ls5;l59.l56=l59.lo5;l59.l46=l59.ln5;this.l97=false;this.la7=false;this.l87=false;}
_jvpcp.onMouseMove=function(e){var lp=this.lz7("root");var l59=this.lz7("pad");var lp5=this.getViewer();if(null==lp5)return;if(lp5.l32){lp.style.cursor=this.lg1(-1);return;}
var mX=this.lx7(e);var mY=this.ly7(e);if(this.l98&&(mX==this.l86)&&(mY==this.l96))return;this.l86=mX;this.l96=mY;var lm9=mX-this.lc5;var ln9=mY-this.ld5;var sd=lp5.lb;var zd=lp5.lc;var ps=l59.style;lp.style.cursor=this.lg1((this.lb5==_jcv.lm5)?this.ly5(mX,mY):this.lb5);this.l95=mX;this.la5=mY;switch(this.lb5){case _jcv.lm5:break;case _jcv.lk5:if(this.ld7()||this.l97)this.l38();this.l97=this.ld7();break;case _jcv.ll5:if(sd!=_jcv.Vertical)l59.lr5=ase_d(this.l17(0),l59.l66+lm9,this.l17(1)-l59.lo5);if(sd!=_jcv.Horizontal)l59.ls5=ase_d(this.l27(0),l59.l76+ln9,this.l27(1)-l59.ln5);this.l38();this.la7=true;break;default:var lv4=l59.l66;var lx4=l59.l76;var lw4=lv4+l59.l56;var ly4=lx4+l59.l46;if(zd!=_jcv.Vertical){switch(this.lb5){case _jcv.Left:case _jcv.BottomLeft:case _jcv.TopLeft:lv4+=lm9;break;case _jcv.Right:case _jcv.BottomRight:case _jcv.TopRight:lw4+=lm9;break;}
}
if(zd!=_jcv.Horizontal){switch(this.lb5){case _jcv.Top:case _jcv.TopLeft:case _jcv.TopRight:lx4+=ln9;break;case _jcv.Bottom:case _jcv.BottomLeft:case _jcv.BottomRight:ly4+=ln9;break;}
}
lv4=ase_d(this.l17(0),lv4,this.l17(1));lw4=ase_d(this.l17(0),lw4,this.l17(1));lx4=ase_d(this.l27(0),lx4,this.l27(1));ly4=ase_d(this.l27(0),ly4,this.l27(1));l59.lo5=Math.abs(lw4-lv4);l59.ln5=Math.abs(ly4-lx4);l59.lr5=Math.min(lv4,lw4);l59.ls5=Math.min(lx4,ly4);this.l38();this.la7=true;break;}
this.l87=this.l87||this.lc7();}
_jvpcp.onMouseUp=function(e){var lp=this.lz7("root");var lp5=this.getViewer();if((null==lp5)||(ase_s(e)!=1)||(!this.l98))return;if(lp.releaseCapture)lp.releaseCapture();window.onmousemove=lp.lo7;window.onmouseup=lp.lp7;this.l98=false;this.lb5=_jcv.lm5;if(this.l97){var ld9=this.lz7("sel");if(ld9.style.visibility!="hidden")this.lc8(ld9.lr5,ld9.ls5,ld9.lo5,ld9.ln5);}
else if(this.la7){this.ls7();}
else if(this.lk8&&!this.l87){var lr9=false;var sd=lp5.lb;if(sd!=_jcv.Vertical){var w=lp5.l6;var lq7=ase_d(0,this.l37(this.l95)-w/2,1-w);lr9=lr9||(lq7!=lp5.l4);lp5.l4=lq7;}
if(sd!=_jcv.Horizontal){var h=lp5.l7;var lr7=ase_d(0,this.l47(this.la5)-h/2,1-h);lr9=lr9||(lr7!=lp5.l5);lp5.l5=lr7;}
if(lr9)lp5.raiseViewPortChangedEvent();}
}
_jvpcp.onTouchStart=function(e){var lp=this.lz7("root");var l59=this.lz7("pad");var lp5=this.getViewer();if((null==lp5)||lp5.l32||ase_t(e))return;this.lx6=null;var e1=e.changedTouches[0];var mX=this.lx7(e1);var mY=this.ly7(e1);if(!this.lu6(mX,mY))return;var lv4=l59.lr5+Math.round((l59.lo5-l59.offsetWidth)/2);var lx4=l59.ls5+Math.round((l59.ln5-l59.offsetHeight)/2);var lw4=lv4+l59.offsetWidth;var ly4=lx4+l59.offsetHeight;var ls9=9999;var lt9=9999;if((mX>=lv4-ls9)&&(mX<=lw4+ls9)&&(mY>=lx4-ls9)&&(mY<=ly4+ls9)){ase_b(e);this.lx6=e1.identifier;this.lb6=mX;this.lc6=mY;l59.l66=l59.lr5;l59.l76=l59.ls5;l59.l56=l59.lo5;l59.l46=l59.ln5;}
}
_jvpcp.onTouchMove=function(e){var lp=this.lz7("root");var l59=this.lz7("pad");var lp5=this.getViewer();var e1=ase_c1(e.changedTouches,this.lx6);if(!(lp5&&e1))return;ase_b(e);var lm9=this.lx7(e1)-this.lb6;var ln9=this.ly7(e1)-this.lc6;this.lb6+=lm9;this.lc6+=ln9;var sd=lp5.lb;if(sd!=_jcv.Vertical)l59.lr5=ase_d(this.l17(0),l59.lr5+lm9,this.l17(1)-l59.lo5);if(sd!=_jcv.Horizontal)l59.ls5=ase_d(this.l27(0),l59.ls5+ln9,this.l27(1)-l59.ln5);this.l38();}
