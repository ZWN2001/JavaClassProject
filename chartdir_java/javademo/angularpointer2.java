...
public class angularpointer2 implements DemoModule
{
    //Name of demo program
    public String toString() { return "Angular Meter Pointers (2)"; }
    ...
    public void createChart(ChartViewer viewer, int chartIndex)
    {
        ...
        // Add a semi-transparent yellow (0x7fffff66) triangular pointer floating between 80% and
        // 90% of the scale radius with the pointer width 5 times the default
    ...
    public static void main(String[] args)
    {
        ...
        DemoModule demo = new angularpointer2();
