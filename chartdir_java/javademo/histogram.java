...
public class histogram implements DemoModule
{
    //Name of demo program
    public String toString() { return "Histogram with Bell Curve"; }
    ...
    public void createChart(ChartViewer viewer, int chartIndex)
    {
        ...
        // Set the plotarea at (50, 30) and of size 500 x 300 pixels, with transparent background
