...
public class semicirclemeterreadout implements DemoModule
{
    //Name of demo program
    public String toString() { return "Semicircle Meter with Readout"; }
    ...
    public static void main(String[] args)
    {
        ...
        DemoModule demo = new semicirclemeterreadout();
