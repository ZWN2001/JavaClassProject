...
public class StatisticianPanel_Self extends JPanel {
    public StatisticianPanel_Self(Statistician_SelfAdd statistician){
        ...
        JLabel titleLabel3=new JLabel("答题时间：");
        titleLabel3.setFont(MyFont.Font_14);
