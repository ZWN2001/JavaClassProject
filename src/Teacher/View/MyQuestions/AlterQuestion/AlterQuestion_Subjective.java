...
public class AlterQuestion_Subjective extends JPanel {
    Container warningArea=new Container();
    BackgroundButton deleteBtn;
    private Question_Subjective question_subjective;
    public AlterQuestion_Subjective(int id,String stemText,int difficulty,int mark,String answer){
        ...
        submitBtn.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (stem.getText().isEmpty()||setMark.getText().isEmpty()){
                    ...
                    try {
                        SubmitQuestion_C submitQuestion_c=new SubmitQuestion_C(question_subjective,"CHANGE_QUESTION_SUBJECTIVE");
